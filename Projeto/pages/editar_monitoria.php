...
<main class="card-grid">
    <div class="card-grid-sair">
        <a href="minhas_monitorias.php" id="linkSair">x</a> 
    </div>
    <form class="container-formulario" id="form-monitoria" method="POST" action="minhas_monitorias.php">
